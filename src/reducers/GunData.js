export default GunData = {
    LowestSMG: {
        ...
        SMG: ['MP40', '伯萊塔38型', 'PPSh-41', 'M3', 'Spectre M4', 'IDW',
    ...
    LowestHG: {
        SP: true,
        threshold: [30, 30, 30, 30],
        HG: ['PPK', 'M1911', '納甘左輪', 'P38', 'FNP-9', 'MP-446', '托卡列夫',
    ...
    GeneralSMG: {
        ...
        SMG: ['斯登MKII', 'UMP9', 'UMP45', 'PP-90', 'Vector', '索米', 'G36C',
            '79式', 'SR-3MP']
    },
    GeneralAR: {
        SP: true,
        AR: ['L85A1', 'G3', '加利爾', 'SIG-510', 'F2000', 'AK-47', 'FNC',
            'StG44', 'OTs-12', 'AS Val', '56式', 'FAMAS', '9A-91', 'HK416', 'G11']
    }, 
    HigherAR: {
        SP: false,
        threshold: [30, 400, 400, 30],
        AR: ['G36', 'TAR-21', 'G41', 'FAL', '95式', '97式']
    },
    GeneralRF: {
        SP: false,
        threshold: [300, 30, 300, 30],
        RF: ['SVT-38', 'G43', 'FN-49', '西蒙諾夫', 'BM59',
            'M1加蘭德', 'M14', 'SV-98', 
            '春田', '莫辛納甘', 'PTRD', 'SVD',
            'WA2000', 'NTW-20']
    },
    HigherRF: {
        ...
        RF: ['漢陽造88式', 'Kar98k', '李-恩菲爾德', 'M99']
    },
    GeneralMG: {
        SP: false,
        threshold: [400, 600, 30, 300],
        MG: ['MG43', 'DP28', 'AAT-52', 'LWMMG', 'FG42',
